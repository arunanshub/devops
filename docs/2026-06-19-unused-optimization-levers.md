...
- **Phase 2 — etcd metrics** ✅ 2a done (ansible `k3s-etcd-metrics.yml` applied + verified). Image-pull parallelism dropped (k3s kubelet rejects `--max-parallel-image-pulls`). **2b gitops kubeEtcd scrape ← NEXT.**
